import { OriginalCard } from "./types/original_card";
import { SpecialAttackData, LingerEffect, LingerEffectOperation, LingerEffectOpTarget } from "./types/special_attack_data";
