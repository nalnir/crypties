...
export const aiRouter = createTRPCRouter({
  generateImages: authenticatedProcedure
    .input(
      z.object({
        prompt: z.string(),
    ...
    .mutation(async (opts) => {
      ...
      try {
        await leonardo.auth(env.LEONARDO_API_KEY ?? '');
  ...
  isFantasyRace: authenticatedProcedure
    .input(
      z.object({
        name: z.string()
      })
  ...
  isPlayerClass: authenticatedProcedure
    .input(
      z.object({
        name: z.string()
      })
  ...
  correctName: authenticatedProcedure
    .input(
      z.object({
        name: z.string()
      })
  ...
  generateDescription: authenticatedProcedure
    .input(
      z.object({
        prompt: z.string(),
      })
